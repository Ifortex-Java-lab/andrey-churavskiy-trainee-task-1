...
public class UserServiceImpl implements UserService {
    ...
    public UserResponseDto createUser(UserRequestDto requestDto) {
        ...
        try {
            ...
            log.debug("Stripe customerId obtained/created for email {}: {}", requestDto.getEmail(), customerId);
        } catch (Exception e) {
            log.error("Stripe customer creation or fetching failed for email: {}", requestDto.getEmail(), e);
